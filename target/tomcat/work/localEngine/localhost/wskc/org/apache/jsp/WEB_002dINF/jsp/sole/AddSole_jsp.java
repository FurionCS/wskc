...
public final class AddSole_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /WEB-INF/jsp/sole/AddSole.jsp(9,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/jsp/sole/AddSole.jsp(132,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_Layout_005foverwrite_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("<script src=\"");
          out.print(request.getContextPath() );
          out.write("/resources/js/my/sole/AddSole.js?v=1\"></script>\r\n");
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/sole/AddSole.jsp(6,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f2(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/sole/AddSole.jsp(12,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_Layout_005foverwrite_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t</li>\r\n");
        out.write("\t\t<li>\r\n");
        out.write("\t\t\t<a href=\"javascript:void(0)\">销售单</a>\r\n");
        out.write("\t\t</li>\r\n");
        out.write("</ul>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">销售单</span>\r\n");
        out.write("\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t</div>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">销售单编码</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
        ...
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">销售类型</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">成本单价(元,必填),默认取库存平均价</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-success \">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"factPrice\" class=\"form-control\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">销售单价(元,必填)</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-success \">\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-success \">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"customer\" class=\"form-control\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">消费者</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input \">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">销售日期</label>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<textarea class=\"form-control\" rows=\"3\" id=\"remark\" placeholder=\"填写销售单备注\" style=\"margin: 0px -4px 0px 0px;\"></textarea>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">备注</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t<div class=\"form-actions noborder\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"btn col-md-4 col-md-offset-4  col-xs-12 btn-lg blue\" onclick=\"submitSole()\">提交</a>\r\n");
        out.write("\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t</form>\r\n");
        out.write("\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t</div>\r\n");
        ...
        out.write("<input type=\"hidden\" id=\"kcnum\"/>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_Layout_005foverwrite_005f2, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/sole/AddSole.jsp(48,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("type");
    // /WEB-INF/jsp/sole/AddSole.jsp(48,12) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/sole/AddSole.jsp(48,12) '${types }'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${types }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_Layout_005foverwrite_005f2, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/sole/AddSole.jsp(106,11) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("statu");
    // /WEB-INF/jsp/sole/AddSole.jsp(106,11) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/sole/AddSole.jsp(106,11) '${status }'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${status }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
