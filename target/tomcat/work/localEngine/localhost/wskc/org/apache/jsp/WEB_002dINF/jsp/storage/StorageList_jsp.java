...
public final class StorageList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /WEB-INF/jsp/storage/StorageList.jsp(9,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/jsp/storage/StorageList.jsp(48,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_Layout_005foverwrite_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("<script src=\"");
          out.print(request.getContextPath() );
          out.write("/resources/js/my/StorageList.js\"></script>\r\n");
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/storage/StorageList.jsp(6,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f2(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/storage/StorageList.jsp(13,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_Layout_005foverwrite_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t</div>\r\n");
        out.write("</div>\r\n");
        out.write("<div class=\"storageList\">\r\n");
        out.write("\t<div id=\"ListBody\" >\r\n");
        out.write("\t</div>\r\n");
        out.write("</div>\r\n");
        org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "../template/storageTemplate.jsp", out, false);
        out.write('\r');
        out.write('\n');
