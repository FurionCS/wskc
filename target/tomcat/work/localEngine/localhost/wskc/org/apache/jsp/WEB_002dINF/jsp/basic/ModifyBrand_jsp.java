...
public final class ModifyBrand_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /WEB-INF/jsp/basic/ModifyBrand.jsp(65,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/basic/ModifyBrand.jsp(6,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/basic/ModifyBrand.jsp(10,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_Layout_005foverwrite_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">修改品牌授权</span>\r\n");
        out.write("\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t</div>\r\n");
        ...
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ubpu.id }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write(" id=\"id\"/>\r\n");
        out.write("\t\t\t\t\t                        <input type=\"text\" class=\"form-control\" id=\"brand\" value=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ubpu.brankName }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" disabled>\r\n");
        out.write("\t\t\t\t\t                        <label for=\"form_control_1\">品牌名称</label>\r\n");
        out.write("\t\t\t\t\t                </div>\r\n");
        out.write("\t\t\t\t\t                <div class=\"form-group form-md-line-input has-success\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"code\" placeholder=\"授权码为8位\" value=\"\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">上家授权码</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-warning\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"remark\" placeholder=\"用于标记上家\" value=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ubpu.pUserRemark }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write(">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">上家备注</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t<div class=\"form-actions noborder\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"btn btn-lg blue\" onclick=\"submitModifyBrand()\">修改</a>\r\n");
