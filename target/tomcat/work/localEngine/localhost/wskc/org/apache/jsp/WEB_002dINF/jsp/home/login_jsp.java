...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("<link href=\"");
      out.print(request.getContextPath() );
      out.write("/resources/admin/pages/css/login-soft.css\" rel=\"stylesheet\" type=\"text/css\"/>\r\n");
      ...
      out.write("\t\t<h3 class=\"form-title\">登录系统</h3>\r\n");
      ...
      out.write("\t\t\t<input type=\"checkbox\" name=\"remember\" value=\"1\"/> 保存账号密码 </label>\r\n");
