...
public final class libraryTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \n");
      out.write("<script type=\"text/html\" id=\"libraryTemplate\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">出库编码:<a href=\"../library/showLibrary?menuids=5_2&id={{id}}\">{{libraryNo}}</a></span>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
