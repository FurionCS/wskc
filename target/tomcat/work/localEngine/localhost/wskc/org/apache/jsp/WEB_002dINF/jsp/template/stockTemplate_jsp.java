...
public final class stockTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \n");
      out.write("<script type=\"text/html\" id=\"stockTemplate\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">产品编码:<a href=\"javascript:void(0)\">{{code}}</a></span>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-7 col-sm-7 col-xs-7 value\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{{modifyTime | dateFormat:'yyyy年 MM月 dd日 hh:mm:ss'}}\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
