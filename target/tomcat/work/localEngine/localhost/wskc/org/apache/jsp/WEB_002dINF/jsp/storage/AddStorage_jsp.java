...
public final class AddStorage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /WEB-INF/jsp/storage/AddStorage.jsp(9,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/jsp/storage/AddStorage.jsp(148,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_Layout_005foverwrite_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("<script src=\"");
          out.print(request.getContextPath() );
          out.write("/resources/js/my/Storage.js\"></script>\r\n");
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/storage/AddStorage.jsp(6,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f2(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/storage/AddStorage.jsp(12,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_Layout_005foverwrite_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t</li>\r\n");
        out.write("\t\t<li>\r\n");
        out.write("\t\t\t<a href=\"javascript:void(0)\">添加入库单</a>\r\n");
        out.write("\t\t</li>\r\n");
        out.write("</ul>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">入库单</span>\r\n");
        out.write("\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t</div>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">入库单编码</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
        ...
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">入库类型</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t                   <div class=\"form-group form-md-line-input\" id=\"purchaseDiv\"> \r\n");
        out.write("\t\t\t\t\t                   \t<label for=\"form_control_1\" >关联采购单</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t  \t<div class=\"input-group\">\r\n");
        out.write("\t\t\t\t\t\t                        <input type=\"text\" class=\"form-control\" id=\"purchase\" placeholder=\"关联采购单,完成入库\">\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t  \t<div class=\"input-group\">\r\n");
        out.write("\t\t\t\t\t\t                        <input type=\"text\" class=\"form-control\" id=\"allocation\" placeholder=\"关联调拨单,完成入库\">\r\n");
        out.write("\t\t\t\t\t\t                        <div class=\"input-group-btn\">\r\n");
        out.write("\t\t\t\t\t\t                            <button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\" style=\"height: 34px;border:none;border-bottom:1px solid #e5e5e5\">\r\n");
        out.write("\t\t\t\t\t\t                                <span class=\"caret\"></span>\r\n");
        out.write("\t\t\t\t\t\t                            </button>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">入库日期</label>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"btn col-md-4 col-md-offset-4  col-xs-12 btn-lg blue\" onclick=\"submitStorage()\">提交</a>\r\n");
        out.write("\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t</form>\r\n");
        out.write("\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t</div>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_Layout_005foverwrite_005f2, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/storage/AddStorage.jsp(52,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("type");
    // /WEB-INF/jsp/storage/AddStorage.jsp(52,12) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/storage/AddStorage.jsp(52,12) '${types }'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${types }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_Layout_005foverwrite_005f2, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/storage/AddStorage.jsp(122,11) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("statu");
    // /WEB-INF/jsp/storage/AddStorage.jsp(122,11) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/storage/AddStorage.jsp(122,11) '${status }'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${status }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
