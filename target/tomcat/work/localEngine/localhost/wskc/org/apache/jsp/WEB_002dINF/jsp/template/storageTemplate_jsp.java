...
public final class storageTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \n");
      out.write("<script type=\"text/html\" id=\"storageTemplate\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">入库编码:<a href=\"../storage/showStorage?menuids=5_1&id={{id}}\">{{storageNo}}</a></span>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
