package org.apache.jsp.WEB_002dINF.jsp.stock;
...
public final class StockList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /WEB-INF/jsp/stock/StockList.jsp(9,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/jsp/stock/StockList.jsp(45,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_Layout_005foverwrite_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("<script src=\"");
          out.print(request.getContextPath() );
          out.write("/resources/js/my/stock/StockList.js\"></script>\r\n");
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/stock/StockList.jsp(6,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f2(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/stock/StockList.jsp(13,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_Layout_005foverwrite_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t</li>\r\n");
        out.write("\t\t<li>\r\n");
        out.write("\t\t\t<a href=\"javascript:void(0)\">库存量查询</a>\r\n");
        out.write("\t\t\t<i class=\"fa fa-circle\"></i>\r\n");
        out.write("\t\t</li>\r\n");
        out.write("</ul>\r\n");
        ...
        out.write("\t\t</div>\r\n");
        out.write("</div>\r\n");
        out.write("<div class=\"stockList\">\r\n");
        out.write("\t<div id=\"ListBody\" >\r\n");
        out.write("\t</div>\r\n");
        out.write("</div>\r\n");
        org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "../template/stockTemplate.jsp", out, false);
        out.write('\r');
        out.write('\n');
