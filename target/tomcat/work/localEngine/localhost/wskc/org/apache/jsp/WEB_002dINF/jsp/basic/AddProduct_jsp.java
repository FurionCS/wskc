...
public final class AddProduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /WEB-INF/jsp/basic/AddProduct.jsp(79,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_Layout_005foverwrite_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("<script src=\"");
          out.print(request.getContextPath() );
          out.write("/resources/js/my/Product.js\"></script>\r\n");
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/basic/AddProduct.jsp(6,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_Layout_005foverwrite_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/basic/AddProduct.jsp(10,0) name = name type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_Layout_005foverwrite_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">添加产品</span>\r\n");
        out.write("\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t</div>\r\n");
        ...
        out.write("\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" id=\"brandId\" name=\"brandName\">\r\n");
        ...
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\" >品牌列表</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-success\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"name\" placeholder=\"产品全称\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">产品全称</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-success\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"code\" placeholder=\"产品编码,一般在包装的二维码下\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">产品编码</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-success\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"size\" placeholder=\"如：300ml\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">产品规格</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group form-md-line-input has-success\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"unit\" placeholder=\"如：盒\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"form_control_1\">产品单位</label>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t\t<div class=\"form-actions noborder\">\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"btn btn-lg blue\" onclick=\"submitProduct()\">提交</a>\r\n");
        out.write("\t\t\t\t\t\t\t\t\t<a href=\"../basic/addUserProduct?menuids=2_3\" class=\"btn btn-lg default\">返回</a>\r\n");
        out.write("\t\t\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t\t\t</form>\r\n");
        out.write("\t\t\t\t\t\t</div>\r\n");
        out.write("\t\t\t\t\t</div>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_Layout_005foverwrite_005f1, PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/basic/AddProduct.jsp(43,11) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("i");
    // /WEB-INF/jsp/basic/AddProduct.jsp(43,11) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/basic/AddProduct.jsp(43,11) '${lubpd}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${lubpd}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${i.brandId }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${i.brandName }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</option>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t");
