...
public final class allocationTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  \n");
      out.write("<script type=\"text/html\" id=\"allocationTemplate\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"caption-subject bold uppercase\">调拨编码:<a href=\"../allocation/showAllocation?menuids=5_0&id={{id}}\">{{allocationNo}}</a></span>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
