...
<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="javascript:void(0)">销售利润统计报表</a>
		</li>
</ul>
			...
			<div class="col-md-12 col-xs-12 ">
							...
							<div class="portlet">
									<div class="caption font-green" style="text-align:center">
										<span class="caption-subject bold uppercase" >各月各产品销售利润折线图</span>
									</div>
...
<script src="<%=request.getContextPath() %>/resources/js/my/sole/SoleNetChart.js?v=4" ></script>
</Layout:overwrite> 
