										...
										<div class="col-md-8 col-sm-12 col-xs-12">
												<div class="portlet-body">
													...
													<div class="row static-info">
														...
														<div class="col-md-7 col-sm-7 col-xs-7 value">
															<fmt:formatNumber type="number" value="${sd.otherFee+sd.deliveryFee+sd.factPrice*sd.num }" pattern="0.00" maxFractionDigits="2"/> 
														</div>
													</div>
													<div class="row static-info">
														<div class="col-md-5 col-sm-5  col-xs-5 name">
													...
													<div class="row static-info">
														...
														<div class="col-md-7 col-sm-7 col-xs-7 value">
															<span class="label label-success">
															 ...
															 <c:if test="${sd.status==3 }">待出库</c:if>
															 <c:if test="${sd.status==4 }">完成</c:if>
													       </span>
														</div>
													</div>
												</div>
