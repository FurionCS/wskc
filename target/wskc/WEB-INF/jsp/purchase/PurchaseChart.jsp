...
<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="javascript:void(0)">采购图表</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
			<a href="javascript:void(0)">采购统计报表</a>
		</li>
</ul>
			...
			<div class="col-md-12 col-xs-12 ">
							...
							<div class="portlet">
									<div class="caption font-green" style="text-align:center">
										<span class="caption-subject bold uppercase" >各月各产品采购金额折线图</span>
									</div>
...
<div class="row">
			<div class="col-md-12 col-xs-12 ">
							...
							<div class="portlet">
									<div class="caption font-green" style="text-align:center">
										<span class="caption-subject bold uppercase" >各月各产品采购数量折线图</span>
									</div>
									<hr style="padding:0;margin:5px 0 0 0;">
								<div class="portlet-body form">
								<div class="row">
...
<script src="<%=request.getContextPath() %>/resources/js/my/purchase/PurchaseChart.js?v=5" ></script>
</Layout:overwrite> 
