...
<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="../library/LibraryList?menuids=5_2">入库单列表</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
			<a href="../library/showLibrary?menuids=5_2&id=${pld.id }">采购单详情</a>
			<i class="fa fa-circle"></i>
		</li>
		<li>
							...
							<div class="portlet light">
									<div class="portlet-title">
										<div class="caption font-green">
											<span class="caption-subject bold uppercase">入库编码:${pld.libraryNo }<a></a></span>
										</div>
									</div>
									...
									<form role="form">
										<div class="form-body">
											<div class="form-group form-md-line-input  has-error" >
												<input type="hidden" value="${pld.id }" id="id"/>
												<input type="text" class="form-control edited" readonly="" value="${pld.productName }" id="form_control_1">
												<label for="form_control_1">产品名称</label>
											</div>
											<div class="form-group form-md-line-input  has-error" >
												<input type="text" class="form-control edited" readonly="" value="${pld.brandName }" id="form_control_1">
												<label for="form_control_1">品牌名称</label>
											</div>
											<div class="form-group form-md-line-input has-success ">
													<input type="text" id="price" class="form-control" value="${pld.price }">
													<label for="form_control_1">单价(元,必填)</label>
											</div>
											<div class="form-group form-md-line-input has-success ">
													<input type="text" id="num" class="form-control" value="${pld.num }" >
											...
											<div class="form-group form-md-line-input  has-info">
												<select class="form-control" id="status">
													...
													<c:forEach var="statu" items="${status }">
														<c:if test="${pld.status==statu.key }">
											...
											<div class="form-group form-md-line-input">
												<textarea class="form-control" rows="3" id="remark" placeholder="填写出库单备注" style="margin: 0px -4px 0px 0px;">${pld.remark }</textarea>
												<label for="form_control_1">备注</label>
											</div>
									</div>
									<div class="form-actions noborder">
										<a href="javascript:void(0)" class="btn col-md-4 col-md-offset-2 col-xs-offset-1 col-xs-5 btn-lg blue" onclick="submitEditLibrary()">提交</a>
										<a href="../library/showLibrary?menuids=5_1&id=${pld.id}" class="btn col-md-4   col-xs-5 btn-lg default" >返回</a>
									</div>
								</form>
							</div>
						</div>
...
<script src="<%=request.getContextPath() %>/resources/js/my/library/EditLibrary.js?v=1"></script>
</Layout:overwrite> 
