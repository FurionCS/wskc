...
<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="javascript:void(0)">出库单列表</a>
		</li>
</ul>
...
<jsp:include page="../template/libraryTemplate.jsp"></jsp:include>
</Layout:overwrite>
...
<script src="<%=request.getContextPath() %>/resources/js/my/library/LibraryList.js"></script>
</Layout:overwrite> 
