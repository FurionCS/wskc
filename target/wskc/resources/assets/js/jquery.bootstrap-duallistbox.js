;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '显示中 {0} 条',                                                       // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">过滤</span> 后 {0} 条，总共 {1} 条', // when not all of the options are visible due to the filter
      infoTextEmpty: '空列表',                                                        // when there are no options present in the list
      filterOnValues: false                                                               // filter by selector's values, boolean
	  , buttonClass: 'btn-white btn-info btn-bold'//ACE
    },
