...
(function (factory) {
    ...
    var Tree = function (element, options) {
        ...
        this.options = $.extend({}, $.fn.fu_tree.defaults, options);
    ...
    Tree.prototype = {
        ...
        selectItem: function (el) {
            ...
            if (this.options.multiSelect) {
                ...
                this.$element.find('.tree-branch.tree-selected').removeClass('tree-selected')
        ...
        selectFolder: function (clickedElement) {
            ...
            if (this.options.multiSelect) {
                ...
                ��������ѡ��������ѡ�и��ڵ㲻��ȡ��
                */
                this.$element.find('.tree-item.tree-selected').removeClass('tree-selected').find('i').removeClass(this.options['selected-icon']).addClass(this.options['unselected-icon']);//ACE;
    ...
    $.fn.fu_tree.Constructor = Tree;

    $.fn.fu_tree.noConflict = function () {
        $.fn.fu_tree = old;
        return this;
    };
