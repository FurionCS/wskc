...
<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="javascript:void(0)">采购单</a>
		</li>
</ul>
<div class="row">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption font-green">
								...
								<span class="caption-subject bold uppercase">采购单</span>
							</div>
						</div>
							...
							<form role="form">
								<div class="form-body">
										<div class="form-group form-md-line-input  has-error" >
											...
											<label for="form_control_1">采购单编码</label>
										</div>
									...
									<div class="form-group form-md-line-input form-md-floating-label">
										<label for="form_control_1">采购日期</label>
									...
									<div class="form-group form-md-line-input">
										<textarea class="form-control" rows="3" id="remark" placeholder="填写采购单备注" style="margin: 0px -4px 0px 0px;"></textarea>
										<label for="form_control_1">备注</label>
									</div>
								</div>
								<div class="form-actions noborder">
									<a href="javascript:void(0)" class="btn col-md-4 col-md-offset-4  col-xs-12 btn-lg blue" onclick="submitPurchase()">提交</a>
								</div>
							</form>
						</div>
					</div>
...
<script src="<%=request.getContextPath() %>/resources/js/my/AddPurchase.js"></script>
</Layout:overwrite> 
