...
<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="javascript:void(0)">添加出库单</a>
		</li>
</ul>
<div class="row">
					...
					<div class="portlet light">
						<div class="portlet-title">
							<div class="caption font-green">
								...
								<span class="caption-subject bold uppercase">出库单</span>
							</div>
						</div>
							...
							<form role="form">
								<div class="form-body">
										<div class="form-group form-md-line-input  has-error" >
											...
											<label for="form_control_1">出库单编码</label>
										</div>
										<div class="form-group form-md-line-input  has-info">
											...
											<label for="form_control_1">出库类型</label>
										</div>
					                   <div class="form-group form-md-line-input" id="soleDiv"> 
					                   	<label for="form_control_1" >关联销售单</label>
										  	<div class="input-group">
						                        <input type="text" class="form-control" id="sole" placeholder="关联销售单,完成出库">
					                  ...
					                  <div class="form-group form-md-line-input" id="allocationDiv" style="display:none"> 
					                   	<label for="form_control_1" >关联调拨单</label>
										  	<div class="input-group">
						                        <input type="text" class="form-control" id="allocation" placeholder="关联调拨单,完成出库">
						                        <div class="input-group-btn">
						                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="height: 34px;border:none;border-bottom:1px solid #e5e5e5">
						                                <span class="caret"></span>
						                            </button>
									...
									<div class="form-group form-md-line-input">
										<label for="form_control_1">出库日期</label>
								...
								<div class="form-actions noborder">
									<a href="javascript:void(0)" class="btn col-md-4 col-md-offset-4  col-xs-12 btn-lg blue" onclick="submitLibrary()">提交</a>
								</div>
							</form>
						</div>
					</div>
...
<script src="<%=request.getContextPath() %>/resources/js/my/library/Library.js?v=1"></script>
</Layout:overwrite> 
