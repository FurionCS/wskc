...
<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="javascript:void(0)">库存量查询</a>
			<i class="fa fa-circle"></i>
		</li>
</ul>
...
<jsp:include page="../template/stockTemplate.jsp"></jsp:include>
</Layout:overwrite>
...
<script src="<%=request.getContextPath() %>/resources/js/my/stock/StockList.js"></script>
</Layout:overwrite> 
